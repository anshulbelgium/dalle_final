  ...
  return (
    <div className='privacy-policy py-5'>
      <Container>
          ...
          <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has been created with the help of the [Free Privacy Policy Generator](https://www.freeprivacypolicy.com/free-privacy-policy-generator/).</p>
          ...
          <p>Company (referred to as either “the Company”, “We”, “Us” or “Our” in this Agreement) refers to dall-efree.</p>
          ...
          <p>Country refers to: Madhya Pradesh, India</p>
          ...
          <h4 className='mt-4'>Service refers to the Website.</h4>
          ...
          <p>Website refers to dall-efree, accessible from https://dall-efree.com/
...
website](<a href='https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking' target='_blank'>https://www.freeprivacypolicy.com/blog/sample-privacy-policy-template/#Use_Of_Cookies_And_Tracking</a>) article.</p>

<h6>We use both Session and Persistent Cookies for the purposes set out below:</h6>
<p>Necessary / Essential Cookies Type: Session Cookies Administered by: Us Purpose: These Cookies are essential to provide You with services
...
<p>Cookies Policy / Notice Acceptance Cookies Type: Persistent Cookies Administered by: Us Purpose: These Cookies identify if users have accepted the use of cookies
on the Website.
</p>
<p>Functionality Cookies Type: Persistent Cookies Administered by: Us Purpose: These Cookies allow us to remember choices You make when You use
...
<h6>We may share Your personal information in the following situations:
</h6>
...
<h6>Retention of Your Personal Data
</h6>
...
<p>By email: <a href='mailto:dall-efree@gmail.com' className='text-dark'>dall-efree@gmail.com</a></p>
      </Container>
    </div>
  )
}
